...
func (c *Client) GetNetworkInventoryItemsWithoutParentId(i int) (*NetworkInventoryItems, error) {
	...
	requestBody := fmt.Sprintf(`{ "params": {"page": %d, "perPage": 100, "filters": {"type": { "computers": true, "virtualMachines": true},"security": {"managedWithBest": true},"depth": {"allItemsRecursively": true}}}, "jsonrpc": "2.0", "method": "getNetworkInventoryItems","id": "tracking"}`, i)
